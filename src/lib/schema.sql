...
-- 'baja_impago'      → pasó el plazo sin pagar (calculado automáticamente)
...
-- ============================================================
-- ACTUALIZACIÓN v10 — Gasto por expediente de siniestro
-- Ejecutar en Supabase SQL Editor
-- ============================================================
alter table siniestros add column if not exists gasto_total numeric(10,2) default null;
alter table siniestros add column if not exists gasto_descripcion text default null;
