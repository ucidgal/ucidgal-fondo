    ...
    <div className="app-shell">
      <nav className="sidebar">
        ...
        <div className="nav-section">
          ...
          <NavLink to="/reglamento" className={({isActive}) => 'nav-item' + (isActive ? ' active' : '')}>
            <span className="nav-icon">§</span> Reglamento
          </NavLink>
        </div>
      ...
      <nav className="bottom-nav">
        ...
        <NavLink to="/reglamento" className={({isActive}) => 'bottom-nav-item' + (isActive ? ' active' : '')}>
          <svg className="bnav-icon" viewBox="0 0 20 20" fill="currentColor"><path fillRule="evenodd" d="M4 4a2 2 0 012-2h4.586A2 2 0 0112 2.586L15.414 6A2 2 0 0116 7.414V16a2 2 0 01-2 2H6a2 2 0 01-2-2V4zm2 6a1 1 0 011-1h6a1 1 0 110 2H7a1 1 0 01-1-1zm1 3a1 1 0 100 2h6a1 1 0 100-2H7z" clipRule="evenodd"/></svg>
          Reglamento
        </NavLink>
