  ...
  return (
    <div>
      ...
      <div className="card" style={{marginBottom:'1.25rem'}}>
        <div className="card-body" style={{padding:'1.25rem 1.5rem'}}>
          <div style={{display:'flex',alignItems:'center',gap:'12px'}}>
            <img src="/logo.png" alt="UCIDGAL" style={{width:'48px',height:'48px',objectFit:'contain',flexShrink:0}} />
            <div>
              <div style={{fontSize:'15px',fontWeight:500,color:'var(--text)'}}>Fondo de Decesos y Repatriación</div>
              <div style={{fontSize:'12px',color:'var(--muted)',marginTop:'2px'}}>Unión de Comunidades Islámicas de Galicia · UCIDGAL · Galicia, España</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div style={{display:'flex',flexDirection:'column',gap:'10px'}}>
        {articulos.map(art => (
          <div key={art.num} className="card" style={art.destacado ? {borderLeft:'3px solid var(--accent)'} : {}}>
            <div className="card-body" style={{padding:'1.25rem 1.5rem',display:'flex',gap:'1.25rem',alignItems:'flex-start'}}>
              ...
              <div style={{flex:1}}>
                <div style={{fontSize:'14px',fontWeight:500,color:'var(--text)',marginBottom:'6px'}}>
                  ...
                  {art.destacado && (
                    <span style={{marginLeft:'8px',fontSize:'10px',padding:'2px 8px',borderRadius:'20px',
                      background:'var(--accent-bg)',color:'var(--accent-dk)',fontWeight:500,verticalAlign:'middle'}}>
                      Actualizado
                    </span>
                  )}
                </div>
      ...
      <div style={{
        ...
        background:'var(--accent-bg)',borderRadius:'var(--radius-lg)',
        ...
        <div style={{display:'flex',gap:'12px',alignItems:'flex-start'}}>
          ...
          <div>
            <div style={{fontSize:'14px',fontWeight:500,color:'var(--accent-dk)',marginBottom:'6px'}}>
              Aceptación de términos y validación digital
            </div>
            <div style={{fontSize:'13px',color:'var(--accent-dk)',lineHeight:1.7,opacity:0.9}}>
              Al cumplimentar el formulario de inscripción o renovación web y marcar obligatoriamente la casilla de aceptación, el miembro declara su total conformidad y acuerdo con todo el contenido del presente reglamento. Dicha acción web, junto con el posterior envío de la tarjeta de afiliación virtual, constituirá la validación formal y el consentimiento explícito del contrato entre ambas partes.
            </div>
          </div>
        </div>
      </div>
