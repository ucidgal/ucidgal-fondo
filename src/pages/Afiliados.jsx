...
{form.tipo_inscripcion === 'familia'
              ...
              {paso === 4 && (
                <div>
                  ...
                  <div style={{background:'var(--bg)',borderRadius:'var(--radius-sm)',padding:'10px 14px',fontSize:'12px',color:'var(--muted)'}}>
                    Los documentos se guardan de forma segura. Podrás añadir o actualizar documentos en cualquier momento desde la ficha del afiliado.
                  </div>
                </div>
              )}
              ...
              {/* Art. 16 — Aceptación del reglamento — moved to paso 3 */}
              {paso === 3 && modal === 'nuevo' && (
                    <div style={{
