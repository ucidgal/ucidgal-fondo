...
export default function Afiliados() {
  ...
  function validarPaso(p) {
    ...
    if (p === 3) {
      ...
      // Validate familia has at least conyuge if tipo is familia
      if (form.tipo_inscripcion === 'familia') {
        const conyuges = (form.hijos || []).filter(h => h.tipo === 'conyuge').length
        if (conyuges === 0) e.conyuge_faltante = 'En inscripción familiar debes añadir los datos del cónyuge. Usa el botón "+ Cónyuge".'
      }
    }
    return e
  }
