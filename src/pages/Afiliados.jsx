          ...
          <div className="modal" style={{maxWidth:'620px'}}>
            ...
            <div className="modal-footer">
              ...
              <button className="btn btn-primary" onClick={() => {
                closeModal()
                navigate('/cuotas', { state: { afiliado_id: selected.id, nombre: `${selected.nombre} ${selected.apellidos}`, num_inscripcion: selected.num_inscripcion } })
              }}>
                <svg style={{width:'13px',height:'13px'}} viewBox="0 0 20 20" fill="currentColor"><path fillRule="evenodd" d="M4 4a2 2 0 00-2 2v4a2 2 0 002 2V6h10a2 2 0 00-2-2H4zm2 6a2 2 0 012-2h8a2 2 0 012 2v4a2 2 0 01-2 2H8a2 2 0 01-2-2v-4zm6 4a2 2 0 100-4 2 2 0 000 4z" clipRule="evenodd"/></svg>
                Registrar pago
              </button>
              <button className="btn" style={{background:'var(--accent-bg)',color:'var(--accent-dk)',borderColor:'var(--accent)'}} onClick={() => { cambiarEstado(selected.id, selected.estado, 'activo'); closeModal() }}>Marcar activo</button>
            </div>
          </div>
        </div>
      )}
