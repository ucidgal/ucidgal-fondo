...
export default function Afiliados() {
  ...
  const filtrosActivos = [filterEstado, filterTipo].filter(f => f !== 'todos').length
  ...
  useEffect(() => {
    ...
    setFiltered(r)
  }, [afiliados, search, filterEstado, filterTipo])

  function limpiarFiltros() {
    setFilter('todos'); setFilterTipo('todos'); setSearch('')
  }
