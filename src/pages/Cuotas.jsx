...
export default function Cuotas() {
  ...
  // Recalculate available afiliados based on currently selected year in form
  const anioForm = Number(form.anio) || ANIO_ACTUAL
  const yaPageronEsteAnio = new Set(
    cuotas.filter(c => c.anio === anioForm && c.estado !== 'anulado').map(c => c.afiliado_id)
  )
