...
export default function Cuotas() {
  ...
  const [anularCuota, setAnularCuota]   = useState(null)
  ...
  async function subirJustificante(file, cuotaId) {
    ...
    if (!allowed.includes(allowed.find(e => e === ext) || '')) {
      setAlerta({ tipo:'error', titulo:'Formato no permitido', mensaje:'Solo se permiten archivos PDF, JPG o PNG.' }); return null
    }
